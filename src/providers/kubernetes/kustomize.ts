 ...
 * `kustomize/vX.Y.Z` â€” we filter on that prefix.
 *
...
export class KustomizeProvider implements Provider {
  ...
  readonly installHint = "winget install Kubernetes.kustomize";
  ...
  async update(_packageId: string): Promise<UpdateOutcome> {
    return delegateUpdate({
      ...
      manualMessage:
        "TÃ©lÃ©charger https://github.com/kubernetes-sigs/kustomize/releases et remplacer kustomize.exe",
    });
  }
