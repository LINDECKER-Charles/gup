...
> Imported on 2026-08-22 from the [GitHub Release](https://github.com/LINDECKER-Charles/gup/releases/tag/0.1.1) body, which had no in-repo source. Verbatim, minus the "What's Changed" block GitHub generates.
